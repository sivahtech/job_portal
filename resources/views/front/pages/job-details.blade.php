    ...
    <div class="container flex">
        ...
        <div class="col right">
            ...
            <div class="apply-div" id="apply-form">
                ...
                @can('employee')
                @if ($check == null)
                <form action="{{ route('apply.job') }}" method="post" enctype="multipart/form-data" class="apply-job" id="apply-job-form">
                    @if (!$check)
                    ...
                    <div class="form-group">
                        ...
                        <div class="adv-input upload">
                            <i class="fa fa-upload"></i><input type="file" accept="application/pdf" id="resume" name="resume" class="form-input" placeholder="Resume">
                        </div>
                    </div>
                    <div class="form-group">
