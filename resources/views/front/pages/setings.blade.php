    ...
    <div class="container flex">
        <div class="col left sidebar">
            <div class="details flex">
                <div class="settng_profile">
                    ...
                    @endif
                    <a href=""><div class="edit-overlay"><i class="fa fa-camera" aria-hidden="true"></i> Replace</div></a>
                ...
                <div class="list">
                    @isset($user->is_porfile_completed)
                    <div class="content">
                        <p class="list-head">Location:</p>
                        <p class="list-des">{{ $user->city->name }} , {{ $user->state->name }} , {{ $user->country->name }}</p>
                    </div>
                    @endisset
                </div>
                @can('employee')
        ...
        <div class="col right">
            <div class="apply-div" id="apply-form">
                <form action="{{ route('profile.update') }}" method="post" enctype="multipart/form-data" class="apply-job">
                    ...
                    <div class="inline">
                        <div class="form-group">
                            ...
                            <div class="adv-input upload">
                                <i class="fa fa-user"></i><input type="text" id="user_name" name="user_name" value="{{ $user->user_name }}" class="form-input" placeholder="User Name">
                            </div>
                            @error('user_name')
                    ...
                    <div class="inline">
                        <div class="form-group">
                            ...
                            <div class="adv-input">
                                <i class="fa fa-user"></i><input type="text" id="first_name" name="first_name" value="{{ $user->first_name }}" class="form-input" placeholder="Your First Name">
                            </div>
                            @error('first_name')
                            <span class="invalid-feedback" role="alert">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <div class="adv-input">
                                <i class="fa fa-user"></i><input type="text" id="last_name" name="last_name" value="{{ $user->last_name }}" class="form-input" placeholder="Your Last Name">
                            </div>
                            @error('last_name')
                            <span class="invalid-feedback" role="alert">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="inline">
                        <div class="form-group">
                            ...
                            <div class="adv-input">
                                ...
                                <input type="text" id="company_name" name="company_name" class="form-input @error('company_name') is-invalid @enderror" placeholder="Company name" value="{{ old('company_name',$user->company_name) }}" required>
                            </div>
                            @error('company_name')
                            <span class="invalid-feedback" role="alert">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <div class="adv-input">
                                ...
                                <select name="company_type" id="company_type" class="form-input @error('company_type') is-invalid @enderror">
                                    ...
                                    <option value="{{ $user->company_type }}" {{ $type == old('company_type',$user->company_type) ?'selected':''  }}>{{ $type }}</option>
                                    @endforeach
                                </select>
                            </div>
                            @error('company_type')
                    ...
                    <div class="inline">
                        <div class="form-group">
                            ...
                            <div class="adv-input">
                                <i class="fa fa-list"></i>
                                <input type="text" id="profile" name="profile" class="form-input @error('profile') is-invalid @enderror" placeholder="Job profile" value="{{ old('profile',$user->profile) }}" required>
                            </div>
                            @error('profile')
                            <span class="invalid-feedback" role="alert">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <div class="adv-input">
                                ...
                                <select name="industry" id="industry" class="form-input">
                                    ...
                                    <option value="{{ $value->id }}" {{ $value->id == old('industry',$user->industry_id)?'selected':'' }}>{{ $value->name }}</option>
                                    @empty
                                    <option value="" selected disabled>Select job Industry</option>
                                    @endforelse
                                </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="adv-input">
                            <i class="fa fa-phone"></i><input type="text" id="phone" name="phone" value="{{ $user->phone }}" class="form-input" placeholder="Phone No">
                        </div>
                    </div>
                    <div class="inline">
                        <div class="form-group">
                    ...
                    <div class="inline">
                        <div class="form-group">
                            ...
                            <div class="adv-input">
                                <i class="fa fa-list"></i>
                                <select name="qualification[]" id="qualification" class="form-input @error('qualification') is-invalid @enderror"  multiple>
                                    @foreach ($data['qualifications'] as $value )
                                    <option value="{{ $value->name }}" {{ in_array($value->name , old('qualification',json_decode($user->qualifications,true) ??[] ))?'selected':""  }}>{{ $value->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            @error('qualification')
                    ...
                    <div class="inline">
                        <div class="form-group">
                            ...
                            <div class="adv-input">
                                <i class="fa fa-user"></i>
                                <input type="text" id="exp" name="exp" class="form-input @error('exp') is-invalid @enderror" placeholder="Experience 1.6 years" value="{{ old('exp',$user->exp) }}" >
                            </div>
                            @error('exp')
                            <span class="invalid-feedback" role="alert">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="inline">
                        <div class="form-group">
                            ...
                            <div class="adv-input">
                                <i class="fa fa-list"></i>
                                <select name="skills[]" id="skills" class="form-input @error('skills') is-invalid @enderror"  multiple>
                                    @foreach (config('job.skills') as $key => $type )
                                    <optgroup label="{{ $key }}">
                                        @foreach ($type as $value )
                                        <option value="{{ $value }}" {{ in_array($value , old('skills',$user->skills->pluck('name')->toArray()??[]))?'selected':""  }}>{{ $value }}</option>
                                        @endforeach
                                    </optgroup>
                                    @endforeach
                                </select>
                    ...
                    <div class="inline">
                        <div class="form-group">
                            ...
                            <div class="adv-input">
                                ...
                                <input type="file" accept="application/pdf" id="resume" name="resume" class="form-input @error('resume') is-invalid @enderror" >
                            </div>
                            @error('resume')
                            <span class="invalid-feedback" role="alert">{{ $message }}</span>
                            @enderror
