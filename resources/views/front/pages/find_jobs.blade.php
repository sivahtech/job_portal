            ...
            <form action="{{ route('find.jobs') }}" method="get" class="search-form" id="search-form">
                <div class="inline">
                    <div class="form-group">
                        <div class="adv-input">
                            <i class="fa fa-briefcase"></i><input type="text" id="title" name="title" class="form-input" placeholder="Job Title" value="{{ request()->title }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="adv-input">
                            <i class="fa fa-list"></i>
                            <input type="text" name="location" class="form-input" id="location" list="locations" placeholder="Job location" value="{{ request()->location }}">
