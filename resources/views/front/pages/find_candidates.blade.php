            ...
            <form action="{{ route('find.candidates') }}" method="GET" class="search-form">
                <div class="inline">
                    <div class="form-group">
                        <div class="adv-input">
                            <i class="fa fa-briefcase"></i><input type="text" id="profile" name="profile" class="form-input" placeholder="Job Profile" value="{{ request()->profile }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="adv-input">
                            <i class="fa fa-list"></i>
                            <input type="text" name="location" class="form-input" id="location" list="locations" placeholder="Location" value="{{ request()->location }}">
    ...
    function handleCheckboxChange(className) {
        document.querySelectorAll(`input[class=${className}]`).forEach(element => {
            element.addEventListener('change', function() {
                var checkedValues = Array.from(document.querySelectorAll(`input[class=${className}]:checked`))
